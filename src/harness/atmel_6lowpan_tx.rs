...
pub unsafe fn set_hooks() {
    ...
    register_hook(0xcd00, rf233::rf233_send as *const fn());
    register_hook(0xcdd0, rf233::rf233_on as *const fn());
    register_hook(0xce2c, rf233::rf233_off as *const fn());
    ...
    register_hook(0x6db0, crate::utils::exit_hook_ok as *const fn());
